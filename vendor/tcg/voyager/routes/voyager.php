...
Route::group(['as' => 'voyager.'], function () {
    ...
    Route::get('test', ['uses' => $namespacePrefix.'VoyagerController@test',     'as' => 'test']);
    Route::get('/load/order', ['uses' => $namespacePrefix.'VoyagerController@loadOrders',     'as' => 'loadOrder']);
    Route::get('/load/order/{id}/{unique_id}', ['uses' => $namespacePrefix.'VoyagerController@loadOrderDetails',     'as' => 'loadOrderDetails']);
    Route::get('order/orderFinish/{id}', ['uses' => $namespacePrefix.'VoyagerController@orderFinish',     'as' => 'orderFinish']);
    Route::get('order/distributed', ['uses' => $namespacePrefix.'VoyagerController@distributed',     'as' => 'distributed']);
    Route::get('order/loadmap/{id}', ['uses' => $namespacePrefix.'VoyagerController@loadMap',     'as' => 'LoadMap']);
