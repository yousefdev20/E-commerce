...
@section('content')
    <div class="page-content">
        ...
        @if(isset(auth()->user()->id) && auth()->user()->role_id == 1)
            <div class="container card text-secondary">
                <a href="{{ url('/admin/test')  }}" class="text-secondary ">
                    <div class="card-body">
                        <img src="/storage/charts/stocks.jpg" alt="Rounded image" width="100%" height="200px" class="card-img-top rounded w-100">
                        <h3 class="">
                            charts
                        </h3>
                    </div>
        ...
        @elseif(isset(auth()->user()->id) && auth()->user()->role_id == 3)
        <div class="container card text-secondary">
            <a href="{{ url('/admin/load/orders')  }}" class="text-secondary ">
                <div class="card-body">
                    <img src="/storage/orders/orders.png" alt="Rounded image" width="100%" height="200px" class="card-img-top rounded w-100">
                    <h3 class="">
                        Orders
                    </h3>
                </div>
